<?php
/**
 * Template Name: Act and Regulation Template
			  ...
			  <tbody>
					...
					?>
					  ...
					  <td style="text-align: center;">
						...
						<?php elseif($link): ?>
						<a href="<?php echo $link; ?>" target="_blank" class="tenderdocs"><img src="<?php echo get_site_url(); ?>/wp-content/uploads/2024/06/link.png" width="25px" title="PDF"></a>
						<?php else: ?>
						<a href="#" target="_blank" class="tenderdocs"><?php echo the_title(); ?></a>
						<?php endif; ?>	
					  </td>
					  </tr>
					<?php 
