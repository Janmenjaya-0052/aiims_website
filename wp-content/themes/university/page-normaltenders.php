<?php
/**
 * Template Name: Normal Tenders Template
  ...
  <div class="py-4">
    <div class="container">
		<div class="inner-content">
			<div class="col-md-12 barchives">
				<button class="view-all"  ><a href="<?php echo get_site_url(); ?>/tenders-archive/">View all</a></button>
			</div>
