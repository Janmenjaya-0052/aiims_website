<?php
/**
 * Template Name: Minutes Of Meeting Template
  ...
  <div class="py-4">
    <div class="container">
		<div class="inner-content">
			<?php if( have_rows('minutes_of_meeting_data') ): $i=0; ?>	
			  <div class="accordion accordion-flush" id="accordionFlushExample">
				<?php while( have_rows('minutes_of_meeting_data') ): the_row(); 
					$title = get_sub_field('meeting_name');
					$i++;
					?>				
				  ...
				  <div id="flush-collapse<?php echo $i; ?>" class="accordion-collapse collapse <?php if($i==1){echo 'show';}?>" data-bs-parent="#accordionFlushExample">
					<div class="accordion-body">
						<table class="table table-bordered table-striped" id="datatable-<?php echo $i; ?>" border="0" cellspacing="0" cellpadding="0">
							...
							<?php if( have_rows('meeting_details') ): $j=0;?>
							<tbody>
								<?php while( have_rows('meeting_details') ): the_row(); 
								...
								<tr>
									<td><?php echo $j;?></td>
									<td><?php echo $name;?></td>
									<td><a href="<?php echo $download; ?>" target="_blank" class="tenderdocs"><img src="<?php echo get_site_url(); ?>/wp-content/uploads/2024/06/pdf_icon.png" width="25px" title="Download PDF"/></a></td>
								</tr>
								<?php endwhile; ?>
