<?php
/**
 * Template Name: PO Tenders Archive Template
    ...
    <div class="container">
		<div class="inner-content">
			...
			<table class="table table-bordered table-striped" id="singles" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <th width="5%"> Corrigendum</th>			  
			  <th width="5%"> Cancellation</th>			  
			  </tr>
			  </thead>
			  <tbody>
					<?php 
						...
						$tender_args = array(
							...
							'tax_query' => array(
								array(
									...
									'terms' => 'po' // Replace with your actual term slug
								)
							),								
						);
					...
					?>
					  ...
					  <td><?php the_field('po_no'); ?></td>					  		  
					  <td><?php the_field('po_dtae'); ?></td>					  		  
					  <td><?php the_field('item_name'); ?></td>					  		  
