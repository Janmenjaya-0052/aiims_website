<?php
/**
 * Template Name: Nursing Intra Mural Template
    ...
    <div class="container">
		<div class="inner-content">
			...
			<table class="table table-bordered table-striped" id="singles" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <th width="5%"> Title</th>
			  <th width="20%">Name of the Faculty</th>
			  <th width="60%"> Title</th>
			  <th width="15%"> Status</th>			  
			  </tr>
			  </thead>
			  <?php if( have_rows('intra_mural_projects_data') ): $count=1; ?>
			  <tbody>
				<?php while( have_rows('intra_mural_projects_data') ): the_row(); 
