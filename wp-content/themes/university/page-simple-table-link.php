<?php
/**
 * Template Name: Simple Table Link Template
    ...
    <div class="container">
		<div class="inner-content">
			...
			<table class="table table-bordered table-striped" id="singles" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?php if( have_rows('table_data') ): $count=1; ?>
			  <tbody>
				<?php while( have_rows('table_data') ): the_row(); 
					...
					?>						
					  ...
					  <td style="text-align: center;">
						...
						<a href="<?php echo $page_link; ?>" target="_blank" class="tenderdocs"><i class="fa-solid fa-link"></i></a>
